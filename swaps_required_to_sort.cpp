...
// The question main part is that the swaps can be minimum in ascending or descending order.
// So should check for both cases.

// geeks for geeks :----http://www.geeksforgeeks.org/minimum-number-swaps-required-sort-array/
